...
for ii = gt.i
  ...
  if ii == 1
    ...
    newFactors.add(ImuFactor( ...
        currentPoseKey-10, currentVelKey-10, currentPoseKey, ...
        currentVelKey, currentBiasKey, currentSummarizedMeasurement, ...
        g, w_coriolis));
    
    % Bias evolution as given in the IMU metadata
    newFactors.add(BetweenFactorConstantBias(currentBiasKey-10, ...
    ...
    if ii > 10 % firstGPSPose + 2*GPSskip
        ...
        if rem(ii,10)==0 % plot every 10 "keyframes"
            cla;
