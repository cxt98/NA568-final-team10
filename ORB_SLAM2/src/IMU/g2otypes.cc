...
{
    auto vPVRi = dynamic_cast<const VertexNavStatePVR*>(_vertices[0]);
    auto vPVRj = dynamic_cast<const VertexNavStatePVR*>(_vertices[1]);
    auto vBiasi = dynamic_cast<const VertexNavStateBias*>(_vertices[2]);
...
{
    auto vBiasi = dynamic_cast<const VertexNavStateBias*>(_vertices[0]);
    auto vBiasj = dynamic_cast<const VertexNavStateBias*>(_vertices[1]);
...
{
    auto vPoint = dynamic_cast<const VertexSBAPointXYZ*>(_vertices[0]);
    auto vNavState = dynamic_cast<const VertexNavStatePVR*>(_vertices[1]);
...
void EdgeStereoNavStatePVRPointXYZ::linearizeOplus()
{
    ...
    Matrix<double, 3, 3> stereoJpi = -stereoMaux / z;
...
{
    auto vNSPVR = dynamic_cast<const VertexNavStatePVR*>(_vertices[0]);
...
{
    auto vNSPVR = dynamic_cast<const VertexNavStatePVR*>(_vertices[0]);
    auto vNSBias = dynamic_cast<const VertexNavStateBias*>(_vertices[1]);
...
{
    // Estimated NavState
    auto vPVR = dynamic_cast<const VertexNavStatePVR*>(_vertices[0]);
...
{
    // Estimated NavState
    auto v = dynamic_cast<const VertexNavState*>(_vertices[0]);
...
void EdgeNavStateGw::computeError()
{
    ...
    auto vj = dynamic_cast<const VertexNavState*>(_vertices[1]);
    auto vg = dynamic_cast<const VertexGravityW*>(_vertices[2]);

    const Vector3d GravityVec = vg->estimate();
...
{
    auto vPoint = dynamic_cast<const VertexSBAPointXYZ*>(_vertices[0]);
    auto vNavState = dynamic_cast<const VertexNavState*>(_vertices[1]);
...
{
    auto vNavState = dynamic_cast<const VertexNavState*>(_vertices[0]);
...
{
    auto v = dynamic_cast<const VertexGyrBias*>(_vertices[0]);
    const Vector3d bg = v->estimate();
