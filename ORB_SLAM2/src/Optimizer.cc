...
void Optimizer::LocalBAPRVIDP(KeyFrame *pCurKF, const std::list<KeyFrame*> &lLocalKeyFrames,
                              bool* pbStopFlag, Map* pMap, cv::Mat& gw, LocalMapping* pLM)
{
    ...
    cout << "gravity vector in world frame:" << endl << GravityVec << endl;
...
int Optimizer::PoseOptimization(Frame *pFrame, Frame* pLastFrame, const IMUPreintegrator& imupreint, const cv::Mat& gw, const bool& bComputeMarg)
{
    ...
    g2o::EdgeNavStatePriorPVRBias* eNSPrior = new g2o::EdgeNavStatePriorPVRBias();
    {
        ...
        eNSPrior->setInformation(pLastFrame->mMarginalCovInv);
...
//            }
    ...
    if(bComputeMarg)
    {
        ...
        pFrame->mMarginalCovInv = margCov.inverse();
...
//            }
    ...
    if(bComputeMarg)
    {
        ...
        pFrame->mMarginalCovInv = margCovInv;
        pFrame->mNavStatePrior = ns_recov;
    }
